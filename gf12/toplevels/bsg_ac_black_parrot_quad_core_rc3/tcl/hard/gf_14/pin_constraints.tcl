...
set last_loc [bsg_pins_line_constraint $tile_req_pins_o_E      "K1 K3" right [expr $last_loc+0.256] $master_tile $tile_req_pins_i_W      2 0]
set last_loc [bsg_pins_line_constraint $tile_resp_pins_o_E     "K1 K3" right [expr $last_loc+0.256] $master_tile $tile_resp_pins_i_W     2 0]
...
set last_loc [bsg_pins_line_constraint $tile_req_pins_o_N      "K2 K4" top   [expr $last_loc+0.256] $master_tile $tile_req_pins_i_S      2 0]
set last_loc [bsg_pins_line_constraint $tile_resp_pins_o_N     "K2 K4" top   [expr $last_loc+0.256] $master_tile $tile_resp_pins_i_S     2 0]
set last_loc [bsg_pins_line_constraint $tile_cmd_pins_o_N      "K2 K4" top   [expr $last_loc+0.256] $master_tile $tile_cmd_pins_i_S      2 0]

set start_x [expr 0.00 + 0.08*3450]
set last_loc [bsg_pins_line_constraint $tile_mem_cmd_pins_i_N  "C5" top   $start_x              $master_tile $tile_mem_cmd_pins_o_S  1 0]
set last_loc [bsg_pins_line_constraint $tile_mem_resp_pins_o_N "C5" top   [expr $last_loc+0.08] $master_tile $tile_mem_resp_pins_i_S 1 0]
...
append_to_collection misc_pins [get_pins -hier $master_tile/* -filter "name=~host*"]

#set start_x [expr $tile_width - 0.08*400]
set_individual_pin_constraints -pins $misc_pins -allowed_layers "C5" -side 2
