...
set bp_input_delay_max_per 20.0
...
## Reg2Reg
remove_clock -all
create_clock -period ${bp_clk_period_ps} -name ${bp_clk_name} [get_ports "core_clk_i rt_clk_i coh_clk_i dma_clk_i"]
...
set_ungroup [get_designs -filter "hdl_template==bp_be_nan_unbox"                 ] true
