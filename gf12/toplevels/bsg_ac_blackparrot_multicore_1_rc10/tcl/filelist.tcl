...
set basejump_ml_atoms_dir  $::env(BLACKPARROT_DIR)/external/basejump_ml_atoms
...
set SVERILOG_SOURCE_FILES [join "
  ...
  $bp_top_dir/src/v/bp_core_tile_node.sv
  $bp_top_dir/src/v/bp_core_tile.sv
  $bp_top_dir/src/v/bp_core.sv
  $bp_top_dir/src/v/bp_core_lite.sv
  $bp_top_dir/src/v/bp_nd_socket.sv

  $bp_me_dir/src/v/network/bp_me_stream_to_wormhole.sv
  $bp_me_dir/src/v/network/bp_me_wormhole_to_stream.sv
  $basejump_stl_dir/bsg_cache/bsg_cache_dma_to_wormhole.v
  $bp_me_dir/src/v/network/bp_me_wormhole_header_encode.sv
  $bp_me_dir/src/v/network/bp_me_wormhole_stream_control.sv
