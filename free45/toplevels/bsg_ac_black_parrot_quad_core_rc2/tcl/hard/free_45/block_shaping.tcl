...
set channel_width 40
set channel_height 40
...
set tile_width  [round_up_to_nearest 960.000 [unit_width ]]
set tile_height [round_up_to_nearest 720.000 [unit_height]]
...
bsg_create_block_array_grid $bp_tile_cells \
  ...
  -y [expr $core_height - $tile_height*$tile_rows - 15*$channel_height] \
  -rows $tile_rows \
  -cols [expr $tile_cols] \
